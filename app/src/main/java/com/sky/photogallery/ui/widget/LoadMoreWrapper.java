...
import com.sky.photogallery.utils.WrapperUtils;
...
public class LoadMoreWrapper extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static final int ITEM_TYPE_NO_MORE_VIEW = Integer.MAX_VALUE - 2;//没有更多了
    public static final int ITEM_TYPE_LOAD_MORE_VIEW = Integer.MAX_VALUE - 3;//加载中
    public static final int ITEM_TYPE_NO_VIEW = Integer.MAX_VALUE - 4;//不显示
